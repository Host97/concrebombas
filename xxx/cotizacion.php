...
$dato_producto = select('bombas', array('idBombas', 'ReferenciaBomba','PrecioBomba',), 'idBombas=' . $_POST['idBombas']);
...
$array_productos =  select('bombas', array('idBombas', 'ReferenciaBomba','PrecioBomba'), '1 ORDER BY ReferenciaBomba');
...
$datoArticulo =  select('bombas', array('idBombas', 'ReferenciaBomba','PrecioBomba'), "ReferenciaBomba='" . $k . "'");
