...
$dato_bomba = select('bombas', array('idBombas', 'ReferenciaBomba','PrecioBomba',), 'idBombas=' . $_POST['idBombas']);

$dato_producto = select('productos', array('idproducto', 'NombreProducto','PrecioProducto',), 'idproducto=' . $_POST['idproducto']);

$dato = mysql_fetch_row($dato_producto);
$dato1 = mysql_fetch_row($dato_Bomba);
...
<form action="cotizacion.php" method="post">
    ...
    <select name="idBombas">
    
  <option></option>
    
  <?php
  
$array_Bombas = select('bombas', array('idBombas', 'ReferenciaBoma',

'PrecioBomba'), '1 ORDER BY ReferenciaBomba');



while ($producto1 = mysql_fetch_array($array_productos)){

echo "<option value='$producto1[0]'>$producto1[1]</option>";
...
$datoArticulo1 = select('bombas', array('idBombas', 'ReferenciaBomba','PrecioBomba'), "ReferenciaBomba='" . $k . "'");

$infoArticulo = mysql_fetch_row($datoArticulo,$datoArticulo1);
...
<?php
	...
	$query="SELECT *  FROM productos,bombas";
