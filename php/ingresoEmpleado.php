    ...
    <body>
        ...
        <div class="section primary-section" id="service">
            <div class="container">
                <!-- Start title section -->
                <div class="title">
                    <h1><!-- InstanceBeginEditable name="tittle1" -->Ingreso Empleado<!-- InstanceEndEditable --></h1>
                    <!-- Section's title goes here --><!-- InstanceBeginEditable name="text1" -->
                    <p>Estas a punto de ingresar a la pagina personal del Empleado</p>
      ...
      <button class="button button-sp" input type="submit" onClick="this.form.action = 'validar_empleado.php'" id="button" value="Ingresar">Ingresar</button>
        ...
        <div class="section secondary-section " id="portfolio">
            <div class="triangle"></div>
             <h1 align="center">&nbsp;</h1>
 <form name="form3" method="post" action="FormularioEmpleado.php">
   <h1 align="center"><strong><br>
   No estas registrado?</strong></h1>
   <p align="center">&nbsp;</p>
   <p align="center">
     <button class="button button-ps" input type="submit" onClick="this.form.action = 'FormularioEmpleado.php'" id="button3" value="Ingresar">Registrar Empleado</button>
   </p>
 </form>
        </div>
            <!-- InstanceEndEditable -->
