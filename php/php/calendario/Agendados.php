...
<body>
	<div id="agenda">
		<h2>Calendario fechas disponibles</h2>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
<p>&nbsp;</p>
		<p>
...
<p>&nbsp;</p>
   ...
   <p align="center">
     <a href="../../index.html">
     <button class="button button-ps" input type="submit" onClick="this.form.action = '../../index.html'" id="button3" value="Ingresar">Volver</button>
     </a>
  </p>
</form>
<script type="text/javascript">
