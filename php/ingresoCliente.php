...
<html lang="es"><!-- InstanceBegin template="/Templates/model.dwt.php" codeOutsideHTMLIsLocked="false" -->
    ...
    <head>
        ...
        <title>Ingreso Cliente -Concrebombas</title>
        <!-- InstanceEndEditable -->
        <!-- Load Roboto font -->
  ...
  <tr>
    ...
    <td><strong><input type="password" name="Password" id="Password" /></strong></td>
      ...
      <p align="center">
      <button class="button button-sp" input type="submit" onClick="this.form.action = 'validar_cliente.php'" id="button" value="Ingresar">Ingresar</button>
    </p>
     </p>
   </div>
</form>
